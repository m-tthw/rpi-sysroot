...
addPreference[Parallel`Palette`paletteConfig["PCT"] -> {Automatic, True, True, "Retry"} ]
...
addPreference[Parallel`Palette`paletteConfig["PCT", "Batch"] -> {Automatic, False, False, "Retry"} ]

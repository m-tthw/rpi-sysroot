...
(* :Package Version: 1.0 alpha ($Id: Palette.m,v 1.100 2012/11/16 10:19:34 maeder Exp $) *)
...
{`autoLaunch, `loadDebug, `tryClone, `recoveryMode}
...
masterConfig[setConfig, {}] := masterConfig[setConfig, {Automatic, True, True, "Abandon"}] (* same as set in Kernel/Preferences.m *)
masterConfig[setConfig, {al_, ld_, cl_, rec_}] := Module[{debugname},
...
masterConfig[getConfig] := {autoLaunch, loadDebug, tryClone, recoveryMode}

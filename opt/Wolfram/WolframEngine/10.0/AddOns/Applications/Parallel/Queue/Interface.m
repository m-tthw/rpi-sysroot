...
(* :Package Version: 2.0 ($Id: Interface.m,v 1.2 2010/03/22 15:19:12 maeder Exp $) *)
...
`$PackageVersion = 2.0;
`$CVSRevision = StringReplace["$Revision: 1.2 $", {"$"->"", " "->"", "Revision:"->""}]

With[{msg="Normal[q] gives a list of the elements of the queue q."},
	If[ValueQ[Normal::usage], Normal::usage = Normal::usage <> " " <> msg, Normal::usage = msg ]]

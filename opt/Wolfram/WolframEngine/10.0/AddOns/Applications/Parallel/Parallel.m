...
(* :Package Version: 3.0 ($Id: Parallel.m,v 1.64 2012/11/26 16:56:21 maeder Exp $) *)
...
`$PackageVersion = 3.0;
`$CVSRevision = StringReplace["$Revision: 1.64 $", {"$"->"", " "->"", "Revision:"->""}]
...
Send[k_kernel, expr_] := Catch[send[k, expr], dead,
	(Message[KernelObject::rdead, k]; CloseError[k]; $Failed)& ]

...
facebookdata[]={
		...
		"ServiceName" 		-> "Facebook", 
	 	...
	 	"Gets"				:> Join[{"FriendIDs","Friends",OAuthClient`Private`gridRequests["FriendsGrid"],"UserData","PageData","PermissionList",
	 			...
	 			"WallPostStatistics",OAuthClient`Private`gridRequests["WallPostStatisticsGrid"],"WallMostCommentedPostData","WallMostCommentedPost","WallMostLikedPostData","WallMostLikedPost",

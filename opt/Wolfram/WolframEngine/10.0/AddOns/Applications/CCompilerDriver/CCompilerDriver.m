...
(******************************************************************************)
lhs:CreateLibrary[code:(_String|{_String ..}), funName_String, 
...
lhs:CreateExecutable[code:(_String|{_String ..}), funName_String, 
	optseq:OptionsPattern[]] :=
	CallCompiler[CreateExecutable, code, funName, 
		Function[{driver, opts}, driver["ExecutableExtension"][Sequence@@opts]], 
		Unevaluated@lhs, {optseq}]

lhs:CreateObjectFile[ code:(_String| {_String ..}), objName_, 
	optseq:OptionsPattern[]] :=

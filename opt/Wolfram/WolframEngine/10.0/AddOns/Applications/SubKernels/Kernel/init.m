...
With[{msg="MachineName[kernel] gives the name of the machine on which kernel runs."},
	If[ValueQ[MachineName::usage], MachineName::usage = MachineName::usage <> " " <> msg,
		MachineName::usage = msg ]]

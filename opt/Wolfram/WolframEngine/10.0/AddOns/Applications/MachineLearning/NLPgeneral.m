...
PackageScope["StringWords"](*
PackageScope["RemoveDiacritic"]
PackageScope["ToLowerCaseUnicode"]*)
...
(*
$toLowerCaseTable = BinaryReadList[GetResourcePath["NLP", "ToLowerCaseTable.bin"], "UnsignedInteger16"];
$toUpperCaseTable = Get[GetResourcePath["NLP", "ToUpperCaseTable.m"]];
$removeDiacriticTable = Get[GetResourcePath["NLP", "RemoveDiacriticTable.m"]];

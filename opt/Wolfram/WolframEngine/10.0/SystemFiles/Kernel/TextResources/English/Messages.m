...
Developer`CalendarData::date = DatePlus::date = DateDifference::date = DateRange::date = DayName::date = LeapYearQ::date = DayRange::date = DayPlus::date = DayCount::date = DayMatchQ::date = BusinessDayQ::date = DayRound::date = "Argument `1` cannot be interpreted as a date."
...
DifferentialRoot::inbrc = "Cannot intepret the given branch cuts in `1`."
...
DMSString::arg = DMSList::arg = FromDMS::arg = "`1` cannot be interpreted as an angle, a DMS list, or a degree-minute-second string form."
DMSString::str = DMSList::str = FromDMS::str = "`1` cannot be interpreted as a degree-minute-second specification."
...
DSolve::deqx = NDSolve::deqx = NDSolveValue::deqx = ParametricNDSolve::deqx = ParametricNDSolveValue::deqx = NDSolve`ProcessEquations::deqx = "Supplied equations are not differential equations of the given functions."
...
DSolve::underdet = RSolve::underdet = RecurrenceTable::underdet = "There are more dependent variables than equations, so the system is underdetermined."
...
DSolve::overdet = RSolve::overdet = RecurrenceTable::overdet = "There are fewer dependent variables than equations, so the system is overdetermined."
...
DSolve::deqn = NDSolve::deqn = NDSolveValue::deqn = ParametricNDSolve::deqn = ParametricNDSolveValue::deqn = NDSolve`ProcessEquations::deqn = NDSolve`Reinitialize::deqn = RSolve::deqn = RecurrenceTable::deqn = "Equation or list of equations expected instead of `1` in the first argument `2`."
...
DSolve::twoivarg = NDSolve::twoivarg = NDSolveValue::twoivarg = ParametricNDSolve::twoivarg = ParametricNDSolveValue::twoivarg = NDSolve`ProcessEquations::twoivarg = RSolve::twoivarg = "The function `1` has two independent variables in one argument. The independent variables should be in separate arguments."
...
DSolve::litarg = NDSolve::litarg = NDSolveValue::litarg = ParametricNDSolve::litarg = ParametricNDSolveValue::litarg = NDSolve`ProcessEquations::litarg = RSolve::litarg = RecurrenceTable::litarg =  "To avoid possible ambiguity, the arguments of the dependent variable in `1` should literally match the independent variables."
...
FindIntegerNullVector::lgrelb = "FindIntegerNullVector has not found an integer null vector for `1` with norm less than or equal to `2` and has proven than no integer null vector with norm less than or equal to `3` exists. Returning a null vector with larger norm."
...
FindIntegerNullVector::rnfb = "FindIntegerNullVector has not found an integer null vector for `1` with norm less than or equal to `2` and has proven than no integer null vector with norm less than or equal to `3` exists."
...
General::eexist = "During evaluation of `1`, an attempt has been made to create a file that already exists."
...
IntegerDigits::ibase = IntegerExponent::ibase = IntegerLength::ibase = ChampernowneNumber::ibase = "Base `1` is not an integer greater than 1."
...
Optimization`LinearProgramming`Simplex::lpsiter = DualLinearProgramming::lpsiter = LinearProgramming::lpsiter = MeanShift::iters = "The value of option MaxIterations -> `1` should be a positive integer or Infinity."
...
Maximize::noobj = Minimize::noobj = MinValue::noobj = MaxValue::noobj = ArgMin::noobj = ArgMax::noobj = "No objective function specified."
...
Maximize::vdom = Minimize::vdom = MinValue::vdom = MaxValue::vdom = ArgMin::vdom = ArgMax::vdom = "Variable domain `1` should be either Reals or Integers."
...
NDSolve::bcnop = NDSolveValue::bcnop = ParametricNDSolve::bcnop = ParametricNDSolveValue::bcnop = NDSolve`ProcessEquations::bcnop = "No places were found on the boundary where `1` was True, so `2` will effectively be ignored."
...
DSolve::conarg = NDSolve::conarg = NDSolveValue::conarg = ParametricNDSolve::conarg = ParametricNDSolveValue::conarg = NDSolve`ProcessEquations::conarg = RSolve::conarg = "The arguments should be ordered consistently."
DSolve::dvnoarg = NDSolve::dvnoarg = NDSolveValue::dvnoarg = ParametricNDSolve::dvnoarg = ParametricNDSolveValue::dvnoarg = NDSolve`ProcessEquations::dvnoarg = RSolve::dvnoarg = RecurrenceTable::dvnoarg = "The function `1` appears with no arguments."
...
NDSolve::ivone = NDSolveValue::ivone = ParametricNDSolve::ivone = ParametricNDSolveValue::ivone = NDSolve`ProcessEquations::ivone = "Boundary values may only be specified for one independent variable. Initial values may only be specified at one value of the other independent variable."
...
NDSolve::ndode = NDSolveValue::ndode = ParametricNDSolve::ndode = ParametricNDSolveValue::ndode = NDSolve`ProcessEquations::ndode = "Input is not an ordinary differential equation."
...
NDSolve::tponly = NDSolveValue::tponly = ParametricNDSolve::tponly = ParametricNDSolveValue::tponly = NDSolve`ProcessEquations::tponly = "Currently the only discretization method implemented is SpatialDiscretization -> TensorProductGrid."
...
NDSolve::tvic = NDSolveValue::tvic = ParametricNDSolve::tvic = ParametricNDSolveValue::tvic = NDSolve`ProcessEquations::tvic = "`1` cannot be used as the temporal independent variable because the conditions `2` for that dimension do not constitute sufficient initial conditions given at only one value of `1`."
...
Take::take = Part::take = Set::take = Internal`BagPart::take = "Cannot take positions `1` through `2` in `3`."
...
RandomChoice::array = RandomInteger::array = RandomReal::array = RandomComplex::array = RandomVariate::array = "The array dimensions `2` given in position 2 of `1` should be a list of non-negative machine-sized integers giving the dimensions for the result."
...
RegularExpression::msg37 = "The Wolfram Language does not support \\L, \\l, \\N, \\P, \\p, \\U, \\u, or \\X in `1`."
...
Set::pvobj = Unset::pvobj = "Property values cannot be assigned for `1` objects."
...
ResetScheduledTask::timnf = RemoveScheduledTask::timnf = StartScheduledTask::timnf = StopScheduledTask::timnf = "Specified task `1` is not found."
...
Transpose::nmtx = ConjugateTranspose::nmtx = "The first two levels of the one-dimensional list `1` cannot be transposed."
...
Transpose::tperm = ConjugateTranspose::tperm = "Permutation `1` is longer than the dimensions `2` of the array."
...
Union::smtst = Intersection::smtst = Complement::smtst = Tally::smtst = Gather::smtst = "Application of the SameTest function yielded `1`, which evaluates to `2`. The SameTest function must evaluate to True or False at every pair of elements."
...
RankedMax::rank = RankedMin::rank = "The rank `1` is not an integer between 1 and `2`."
...
General::vprobprm = "The value `1` at position `2` in `3` is expected to be a list of numbers greater than or equal to 0 and summing to 1."
General::vprobprm2 = "The value `1` at position `2` in `3` is expected to be a list of numbers between 0 and 1 inclusive."
General::vsprobprm = "The value `1` at position `2` in `3` is expected to be a list of numbers greater than or equal to 0 and summing to less than 1."
...
RawArray::aotd = Language`NewArrayObject::aotd = Language`NewRawArray::aotd = "Elements in `1` are inconsistent with type `2`."
...
LocalAdaptiveBinarize::bdparams = "The argument `1` should be a list of three real numbers."
...
MinDetect::arg1 = MaxDetect::arg1 = GaborFilter::arg1 = GradientFilter::arg1 = GaussianFilter::arg1 = LaplacianGaussianFilter::arg1 = LaplacianFilter::arg1 = MeanFilter::arg1 = GeometricMeanFilter::arg1 = HarmonicMeanFilter::arg1 = Image`TrimmedMeanFilter::arg1 = (*ContraharmonicMeanFilter::arg1 =*) MedianFilter::arg1 = MinFilter::arg1 = MaxFilter::arg1 = CommonestFilter::arg1 = StandardDeviationFilter::arg1 = EntropyFilter::arg1 = Erosion::arg1 = Dilation::arg1 = Opening::arg1 = Closing::arg1 = GeodesicOpening::arg1 = GeodesicClosing::arg1 = TopHatTransform::arg1 = BottomHatTransform::arg1 = GeodesicDilation::arg1 = GeodesicErosion::arg1 = BilateralFilter::arg1 = KuwaharaFilter::arg1 = MeanShiftFilter::arg1 = GradientOrientationFilter::arg1 = "The first argument `1` is neither a rectangular array nor an image."
...
EdgeDetect::bdrad = CornerFilter::bdrad = Blur::bdrad = Sharpen::bdrad = "The specified radius `1` should be either a non-negative number or a list of `2` non-negative numbers."
...
ImageMeasurements::roi = DominantColors::roi = ImageApply::roi = ImageApplyIndexed::roi = ImageFilter::roi = "Expecting an image or a graphics object to define the region of interest instead of `1`."
ImageMeasurements::roi3d = DominantColors::roi3d = ImageApply::roi3d = ImageFilter::roi3d = "Expecting a 3D image or a 3D integer array object to define the region of interest instead of `1`."
...
EdgeDetect::bdmtd = ImageLines::bdmtd = ImageCorners::bdmtd = ImageCollage::bdmtd = ImageSaliencyFilter::bdmtd = CornerFilter::bdmtd = Radon::bdmtd = WatershedComponents::bdmtd = CommonImages::mthd = "Value of Method -> `1` is not a valid method specification."
...
BarChart::chspc = RectangleChart::chspc = BarChart3D::chspc = RectangleChart3D::chspc = BoxWhiskerChart::chspc = DistributionChart::chspc = "Value of option BarSpacing -> `1` is not a size or pair of sizes."
...
Histogram::hbins = Histogram3D::hbins = DensityHistogram::hbins = PairedHistogram::hbins = HistogramList::hbins ="The bin specification `` cannot be used to determine either how many or which bins to use."
Histogram::hspec = Histogram3D::hspec = DensityHistogram::hspec = PairedHistogram::hspec = HistogramList::hspec = "The height specification `` is not one of the named height functions or a function that can be used to compute the heights for each bin."
Histogram::hfilter = Histogram3D::hfilter = DensityHistogram::hfilter = PairedHistogram::hfilter = HistogramList::hfilter = "The data filter `` could not be used to filter data from the dataset."
...
ImageHistogram::opapp2 = "Value of option Appearance -> `1` for multichannel, non-RGB images is not one of Automatic, Transparent, Stacked, or Separated."
General::ltrng = "Invalid latitude specification in `1`."
General::invdtm = "Unknown geodetic datum `1`. Use GeodesyData[\"Datum\"] for a list of available named datums."
GeoPositionENU::origin = "Second argument in `1` is expected to be a GeoPosition, GeoPositionENU or GeoPositionXYZ object."
GeoGridPosition::invset = "`1` is not a valid setting."
GeoGridPosition::invproj = "`1` is not a valid projection specification."
General::invspec = "`1` cannot be interpreted as a DMS numerical specification."
DMSString::invset = "`1` is not a valid setting."
GeoDestination::invazm = "`1` is not a valid {distance, azimuth} specification."
...
General::invparam = "Invalid parameters `1`."
...
InverseRadon::bddim = Image`TransformPixelCoordinates::bddim = Radon::bddim = RandomImage::bddim = "The specified dimensions `1` should be a pair of positive integers."
...
ConstantImage::bddim = "The specified dimensions `1` should be a pair or a triplet of positive integers."
...
ImageCollage::bddim = "The specified dimensions `1` should be a pair of positive integers."
ImageCollage::backgr = "The specified value Background -> `1` is not a valid color directive, Automatic, or None."
...
HighlightImage::mkinv = ImageForestingComponents::mkinv = WatershedComponents::mkinv = ChanVeseBinarize::mkinv = RegionBinarize::mkinv = MeanShift::parti = "Expecting either an image or graphics with dimensions `2` or a list of positions to specify markers instead of `1`."
...
StateResponse::methodtd="The method `1` can not be used for TemporalData inputs."
...
RootLocusPlot::delays = "RootLocusPlot does not support systems with delays in the closed-loop characteric equation."
...
FeedbackLinearize::iters = AsymptoticOutputTracker::iters = SystemsModelVectorRelativeOrder::iters = Control`VectorRelativeOrderCompensator::iters = "The value of option MaxIterations -> `1` should be a positive machine integer or Automatic."
SystemsModelVectorRelativeOrder::dmatrk = "The decoupling matrix `1` has rank `2`, but the number of outputs is `3`."
SystemsModelVectorRelativeOrder::dmatnz = "Unable to find a nonzero row in the decoupling matrix for output `1`."
...
TensorDimensions::fscl = TensorRank::fscl = "Nonscalar expression `1` encountered as an argument of numeric function `2`."
...
ChanVeseBinarize::area = "The value of \"AreaPenalty\" option should be a real number instead of `1`."
ChanVeseBinarize::length = "The value of \"LengthPenalty\" option should be a non-negative real number instead of `1`."
...
LQRegulatorGains::method= LQOutputRegulatorGains::method= LQEstimatorGains::method=DiscreteLQRegulatorGains::method=DiscreteLQEstimatorGains::method= "The method `1` is not one of {\"RiccatiSolveOptions\" -> {Method -> \"Eigensystem\"}}, {\"RiccatiSolveOptions\" -> {Method -> \"Schur\"}}, or Automatic.";
...
FindGeometricTransform::input="`1` and `2` should be images, polygons, lines, points, BSplineCurves, BezierCurves, or the same dimensional points sets of equal length."
FindGeometricTransform::nocp ="Images `1` and `2` do not share any corresponding points."
FindGeometricTransform::bdmethod ="Method in `1` should be RANSAC, linear, or FindFit."
FindGeometricTransform::insufficientPts= "Need at least `1` non-degenerate pairs of points for `2` transformation estimation."
FindGeometricTransform::bdtrnsf ="Transformation `1` is invalid."
FindGeometricTransform::converge="FindFit failed to converge; try other methods."
FindGeometricTransform::bdpts = "No `1` transformations can be found for given point sets."
...
ImageAlign::pts="Only `1` correspondences are found; not enough for alignment."
ImageAlign::size=" One of the image dimensions `1` is less than 4. This function requires a minimum of four pixels along the dimension to be processed."
ImageAlign::bdtrnsf ="Transform function `1` is invalid for this method."
...
DerivativeFilter::intord = "Value of InterpolationOrder -> `1` should be Automatic or a positive, odd integer less than or equal to 9."
DerivativeFilter::intordl = "Value of InterpolationOrder -> `1` should be a list of Automatic or positive, odd integers less than or equal to 9."
...
RidgeFilter::intord = "Value of InterpolationOrder -> `1` should be Automatic or a positive, odd integer less than or equal to 9."
RidgeFilter::intordl = "Value of InterpolationOrder -> `1` should be a list of Automatic or positive, odd integers less than or equal to 9."
...
MatrixPower::sing = MatrixLog::sing = LinearAlgebra`MatrixLog::sing = LinearAlgebra`MatrixSqrt::sing = "Found a singularity when computing the square root of the matrix `1`."
...
LogRankTest::wtmthd = "The weight specification `1` at position `2` is expected to be one of \"AndersonPeto\", \"Equal\", \"Gehan\", \"Peto\", \"TaroneWare\", a non-negative integer, or pair of non-negative integers.";
...
Periodogram::sndinv = PeriodogramArray::sndinv = Spectrogram::sndinv = SpectrogramArray::sndinv = BandpassFilter::sndinv = BandstopFilter::sndinv = DifferentiatorFilter::sndinv = HilbertFilter::sndinv = LowpassFilter::sndinv = HighpassFilter::sndinv = RecurrenceFilter::sndinv = "This sound object is not supported." 
...
TemporalData::ntprs = "The argument `1` at position 1 is expected to be a list of time\[Hyphen]value pairs or a list of states with equal dimensionality."
TemporalData::stspcln = "The number of paths implied by the states `1` and time stamps `2` do not match."
TemporalData::invstrct = "The data `1` is not a structurally valid TemporalData object."
TemporalData::bdslc = "The input `1` cannot be interpreted as a time point or list of time points."
...
TemporalData::prtspc = "Unable to determine the times intended by `1`."
TemporalData::dpcts = "Duplicate time stamps were found. Time stamps should be unique."
TemporalData::badarg = "The lengths implied by the states `1` and time stamps `2` do not match."
...
PartialCorrelationFunction::bdlag = "The lag specification `1` should be a symbol, a non\[Hyphen]zero integer with magnitude less than the length of the data, or a range specification indicating such integers."
...
General::insffdt  = "There is insufficient data to proceed with computation. The data must contain at least `1` elements. "
...
CommonImages::bdopts = "The specified options `1` are not valid options for the specified images and will be ignored."

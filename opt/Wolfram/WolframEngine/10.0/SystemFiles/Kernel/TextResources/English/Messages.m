...
DMSString::ang = DMSList::ang = FromDMS::ang = "`1` cannot be interpreted as a DMS angle specification."
...
DSolve::deqn = NDSolve::deqn = NDSolveValue::deqn = ParametricNDSolve::deqn = ParametricNDSolveValue::deqn = NDSolve`ProcessEquations::deqn = NDSolve`Reinitialize::deqn = RSolve::deqn = RecurrenceTable::deqn = NDSolve`Shooting::deqn = "Equation or list of equations expected instead of `1` in the first argument `2`."
...
Optimization`LinearProgramming`Simplex::lpsiter = DualLinearProgramming::lpsiter = LinearProgramming::lpsiter = MeanShift::iters = ImageFeatureTrack::iters = "The value of option MaxIterations -> `1` should be a positive integer or Infinity."
...
ConfigureEngine::filecreate = "Launch Manager encountered an error while trying to write a file to its local filesystem."
...
ManagerRestart::auth = "Launch Manager restart command does not have permission to restart the manager."
ManagerStop::auth = "Launch Manager stop command does not have permission to stop the manager."
TerminateEngine::auth = "Launch Manager terminate engine command does not have permission to terminate an engine."
...
NDSolve::bcnop = NDSolveValue::bcnop = ParametricNDSolve::bcnop = ParametricNDSolveValue::bcnop = NDSolve`ProcessEquations::bcnop = NDSolve`FEM`DiscretizeBoundaryConditions::bcnop = "No places were found on the boundary where `1` was True, so `2` will effectively be ignored."
...
(* NumericalRegion *)
NDSolve`FEM`NumericalRegion::vbnd = "The extent of the bounds `1` is not valid."
...
NDSolve::femweo = NDSolveValue::femweo = ParametricNDSolve::femweo = ParametricNDSolveValue::femweo = NDSolve`ProcessEquations::femweo = NDSolve`FEM`InitializePDEMethodData::femweo = NDSolve`FEM`InitializeFEMMethodData::femweo = "The requested element order `1` must not be larger than the mesh order and has be reduced to `2`."
NDSolve::femnro = NDSolveValue::femnro = ParametricNDSolve::femnro = ParametricNDSolveValue::femnro = NDSolve`ProcessEquations::femnro = NDSolve`FEM`InitializePDEMethodData::femnro = NDSolve`FEM`InitializeFEMMethodData::femnro = "Node reordering cannot be used with mixed element order. Set \"NodeReordering\" -> False."
...
TemporalData::stdmns = TimeSeries::stdmns = EventSeries::stdmns = "The argument `1` is expected to be Automatic or a positive integer."
...
TemporalData::pthspc = TimeSeries::pthspc = EventSeries::pthspc = "The path specification `1` is expected to be one of All, a positive integer less than or equal to the number of paths, a list of such integers, or a span corresponding to such a list."
...
TimeSeriesAggregate::bdwndwspc = "The window specification `1` is invalid."
...
ConicHullRegion::ppts = "`1` should be a point or a list of points."
ConicHullRegion::pts = "`1` should be a non-empty list of points."
ConicHullRegion::vec = "`1` should be a list of real vectors of length `2`."
...
Inactive::acinac = "A combination of active and inactive forms of the operator `1` has been detected in flat expression `2`. Consider adding parantheses to clarify intent.";
Inactive::mltops = "Two different inactive operators `1` and `2` have been been detected in flat expression `3`. Consider adding parantheses to clarify intent.";
...
MeshRegion::bdcoord = BoundaryMeshRegion::bdcoord = "The coordinates given at position `1` in `2` are not a list of real-valued points in the same dimension."
...
DiscretizeRegion::bdbnds = BoundaryDiscretizeRegion::bdbnds = "The bounds given at position `2` of `1` are not a list of {min, max} pairs of length `3`."
...
GeoBounds::ranges = "Cannot compute ranges of longitude and latitude for the geo input `1`."
...
GeoGraphics::invgm = "`1` is not a valid GeoModel specification."
GeoGraphics::autogm = "Different geo models `1` found. GeoModel->Automatic requires all geodetic positions to use the same geo model."
GeoGraphics::invgmrm = "Geo model `1` and projection reference model `2` are not compatible."
GeoGraphics::geoingm = "Different geo models `1` and `2` found."
...
GeoGraphics::grpad = "Unable to implement padding specification `1`."
GeoGraphics::data = "Unable to download data for ranges `1`, zoom level `2`, and map styling `3`."
GeoGraphics::gscl = "The value of the option GeoScale -> `` should be Automatic, None, a unit or unit system, or a list of distances."
GeoGraphics::missloc = "Unable to obtain location information for `1`."
...
GeoNearest::noloc = GeoWithinQ::noloc = GeoEntities::noloc = GeoIdentify::noloc = GIS`GeoEntityTypes::noloc = GeoDistance::noloc = "Location not available for: `1`."

...
If[$SystemID === "Linux-ARM",
	...
	RaspiCurrentImage[{iHandle_, dHandle_}, {width_Integer,height_Integer},options_String]:= Import[ "!raspistill -n -w "<> ToString[ width] <> " -h " <> ToString[ height] <> " -t 1 -o -" <> " " <> ToString[options], {"JPG","ImageWithExif"}];

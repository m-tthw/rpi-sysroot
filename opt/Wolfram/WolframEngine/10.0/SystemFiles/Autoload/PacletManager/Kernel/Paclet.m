...
CreatePaclet::badpi = "`1` is not a properly formatted PacletInfo.m file. You can use the VerifyPaclet function to get more detailed information about the error."
CreatePaclet::badppi = "The paclet `1` does not have a properly formatted PacletInfo.m file. You can use the VerifyPaclet function to get more detailed information about the error."
CreatePaclet::badarg = "`1` must be a .paclet file, a PacletInfo.m file, or a directory containing a PacletInfo.m file."
...
createPacletFromPackedFile[pathToPacletFile_String] :=
    Module[{dataBuffer, piData, piExpr},
        ...
        (* else *)
            (* Message will have already been issued from ZipGetFile, but we want to add an explicit paclet-related one. *)
            Message[CreatePaclet::badppi, pathToPacletFile];
            $Failed
        ]
    ]
...
VerifyPaclet::path = "`1` must be a .paclet file, a PacletInfo.m file, or a directory containing a PacletInfo.m file."
VerifyPaclet::notfound = "Could not find specified file `1`."
VerifyPaclet::nopi = "The directory `1` does not have a PacletInfo.m file in it."
VerifyPaclet::noppi = "The paclet archive `1` does not appear to have a PacletInfo.m file in it."

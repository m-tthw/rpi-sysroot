...
VisualStudioCompiler["SupportedTargetSystemIDQ"]["Windows-x86-64", 
	...
	TrueQ@Quiet@With[{supportsQ = Function[compiler, 
		Directory === 
		FileType[FileNameJoin[{$ThisDriver["ResolveInstallation"][installation],
			"VC", "bin", compiler}]]]
		},
		supportsQ["x86_amd64"] || supportsQ["amd64"]
	]
...
VisualStudioCompiler["ResolveInstallation"][Automatic] := 
	VisualStudioCompiler["ResolveInstallation"][$VisualStudioVersions]

VisualStudioCompiler["ResolveInstallation"][versions_List] := 
...
VisualStudioCompiler["Installations"][] := 
	Map[installPath, $VisualStudioVersions]
...
VCVarsCall[installation_, targetSystemID_] := 
	StringJoin["call \"", VCVarsPath[installation], "\" ", 

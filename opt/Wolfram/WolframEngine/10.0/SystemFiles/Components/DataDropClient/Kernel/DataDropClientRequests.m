...
$authenticatedrequests={"Data","WebReport","Report", "FullRecords","WebForm","Values","EventSeries","TimeSeries"};
...
datadropexecute[id_,"FullRecords",rest___]:=datadropFullRecords[id,rest];

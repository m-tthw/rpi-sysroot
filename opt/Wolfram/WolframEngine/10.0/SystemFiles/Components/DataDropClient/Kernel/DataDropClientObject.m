...
(************* UpValues *******************)
databinUpValueFunctionsMap={BarChart, BoxWhiskerChart, DateListPlot, DistributionChart, 
		...
		With[{fullid=loaddatabin[id]},
			If[$VersionNumber>=10&&StringQ[fullid],
				BoxForm`ArrangeSummaryBox[
					...
					(* Icon *)icon, 
					(* Column or Grid *){	BoxForm`SummaryItem[{"Short ID: ", getShortBinID[fullid]}],
					BoxForm`SummaryItem[{"Entries: ", Dynamic[Lookup[Replace[
							datadropclientcache[{"DatabinStats", fullid}],Except[_Association]->{},{0}],"Entries",0]]}]}, 
					(* Plus Box Column or Grid *){
						BoxForm`SummaryItem[{"Name: ", getBinName[id]/.None->Style["None",Gray]}],
						...
						BoxForm`SummaryItem[{"Creation date: ", getCreationDate[fullid]}],
						BoxForm`SummaryItem[{"Latest date: ", Dynamic[
							Lookup[Replace[datadropclientcache[{"DatabinLatest", fullid}],Except[_Association]->{},{0}],"Timestamp",Missing[]]]}], 
						BoxForm`SummaryItem[{"Size: ", Dynamic[
						...
						Sequence@@(If[#=!=None,{BoxForm`SummaryItem[{"ExpirationDate: ", #}]},{}]&@getExpirationDate[fullid])

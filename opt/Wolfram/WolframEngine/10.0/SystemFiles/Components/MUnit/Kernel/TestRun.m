...
(*
$CurrentFile is deprecated, but must keep around for backward-compatibility
*)
...
midTestRun[testFileName:Except[_String|_List], OptionsPattern[]]/;StringQ[testFileName] := 

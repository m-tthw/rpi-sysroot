...
XMLSchema`Information`$CreationID = If[SyntaxQ["2"], ToExpression["2"], 0]
XMLSchema`Information`$CreationDate = If[SyntaxQ["{2013, 10, 29, 14, 34, 18}"], ToExpression["{2013, 10, 29, 14, 34, 18}"], {0,0,0,0,0,0}]

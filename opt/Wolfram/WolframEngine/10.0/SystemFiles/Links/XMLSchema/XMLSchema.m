...
XMLSchema`Information`$CreationID = If[SyntaxQ["3"], ToExpression["3"], 0]
XMLSchema`Information`$CreationDate = If[SyntaxQ["{2013, 12, 06, 10, 24, 57}"], ToExpression["{2013, 12, 06, 10, 24, 57}"], {0,0,0,0,0,0}]

TARGETS = mountkernfs.sh fake-hwclock hostname.sh udev keyboard-setup mountdevsubfs.sh console-setup networking mountall.sh mountall-bootclean.sh urandom alsa-utils mountnfs.sh mountnfs-bootclean.sh x11-common kbd checkroot.sh bootmisc.sh procps checkfs.sh mtab.sh plymouth-log kmod checkroot-bootclean.sh udev-mtab
